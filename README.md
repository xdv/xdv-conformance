...
Primary specification: XDV-084 in xdv-spec.

## Purpose

Certification-grade conformance and determinism validation suite.

## Scope

This project is responsible for:

- Implementing normative requirements defined by XDV-084.
...
- xdv-kernel, xdv-runtime, xdv-replay, xdv-diagnostics
...
dust check xdv-conformance/src

## Test

dust test xdv-conformance/tests
